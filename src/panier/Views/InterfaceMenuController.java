...
import panier.Interfaces.commandeInterface;
import panier.Interfaces.panierInterface;
import panier.Interfaces.produitInterface;
import panier.Services.CommandeService;
import panier.Services.MailerService;
...
//       ImageProduit.setImage(image);
    ...
    public void setCommandeDetails(Commande c) {
        ...
        try {
            for (int i = 0; i < c.getPaniers().size(); i++) {
                ...
                fxmlLoader.setLocation(getClass().getResource("LigneCommandeInterface.fxml"));
    ...
    private void listDesPaniers(Utilisateur u) {
        ...
        try {
            for (int i = 0; i < paniers.size(); i++) {
                FXMLLoader fxmlLoader = new FXMLLoader();
                fxmlLoader.setLocation(getClass().getResource("unePanierInterface.fxml"));
                AnchorPane anchorPane = fxmlLoader.load();
    ...
    private void listDesPlats() {
        ...
        try {
            for (int i = 0; i < produits.size(); i++) {
                FXMLLoader fxmlLoader = new FXMLLoader();
                fxmlLoader.setLocation(getClass().getResource("unProduitInterface.fxml"));
                AnchorPane anchorPane = fxmlLoader.load();
    ...
    private void listDesCommandes() {
        ...
        try {
            for (int i = 0; i < commandes.size(); i++) {
                FXMLLoader fxmlLoader = new FXMLLoader();
                fxmlLoader.setLocation(getClass().getResource("uneCommandeInterface.fxml"));
                AnchorPane anchorPane = fxmlLoader.load();
    ...
    private void validerCommande(ActionEvent event) {
        ...
        try {
            fxml =  FXMLLoader.load(getClass().getResource("InterfacePaiement.fxml"));
    ...
    private void logout(ActionEvent event) throws IOException {
           JOptionPane.showMessageDialog(null, "Connexion etablie");
                        ...
                        interfacePlats.getScene().getWindow().hide();
                        FXMLLoader loader = new FXMLLoader();
                        loader.setLocation(getClass().getResource("../../edu/gui/Login.fxml"));
                        loader.load();
